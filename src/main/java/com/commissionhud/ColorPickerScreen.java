...
public class ColorPickerScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(textRenderer, Text.literal("Hue & Saturation"), wheelCenterX, wheelCenterY - wheelRadius - 15, 0xCCCCCC);
        context.drawCenteredTextWithShadow(textRenderer, Text.literal("Bright"), sliderX + sliderWidth / 2, sliderY - 12, 0xCCCCCC);
        context.drawTextWithShadow(textRenderer, Text.literal("Preview:"), previewX - 50, previewY + 10, 0xCCCCCC);
    ...
    private void drawColorPreview(DrawContext context) {
        ...
        // Labels
        context.drawCenteredTextWithShadow(textRenderer, Text.literal("Old"), previewX + previewSize / 2, previewY + previewSize + 2, 0x888888);
        context.drawCenteredTextWithShadow(textRenderer, Text.literal("New"), newPreviewX + previewSize / 2, previewY + previewSize + 2, 0x888888);
    }
